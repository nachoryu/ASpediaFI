...
GSE114922.ASpediaFI <- ASpediaFI(sample.names = c("GSM3167287", "GSM3167290"),
...
as.table(GSE114922.ASpediaFI)[1:10, 2:5]
...
visualize(GSE114922.ASpediaFI,
          node = as.table(GSE114922.ASpediaFI)$EventID[10], zoom = FALSE)
@
