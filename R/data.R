...
#'
#'A SummarizedExperiment containing PSI values of 5,000 AS events. We downloaded
...
#'82 MDS patients from GEO database (GSE114922), aligned with STAR, and obtained
#'FPKM values using RSEM.
#'
#'@name GSE114922.fpkm
#'@docType data
#'@references Pellagatti, A. et al. (2018). Impact of spliceosome mutations on
